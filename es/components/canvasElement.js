...
var CanvasElement = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(CanvasElement, [{
    ...
    key: "handleSave",
    value: function handleSave(consolidatedData, linkedFields) {
      if (this.props.isDebug) console.log("inside of function handleSave in canvasElement.js");
      this.props.setEditingOnCanvas(false);
      this.props.onClickSave(consolidatedData, linkedFields); // this.setState({ editing: false, editForm: null });  //might have to change this line to be similar to the "handleConfirm" logic
    }
  }, {
    key: "handleLoad",
