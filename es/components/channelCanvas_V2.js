...
class ChannelCanvas_V2 extends _react.default.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      //elementList: [],
          ...
          for (let slot in componentSettings) {
            ...
            if (slot.includes("AdditionalSlot_")) {
              for (let index in settingDatas) {
                ...
                let partialSlots = [];
                if (this.state.slots[slot] !== null && this.state.slots[slot] !== undefined) partialSlots = this.state.slots[slot];
    ...
    this.handleClick_additionalItemButton = this.handleClick_additionalItemButton.bind(this);
    ...
    this.handleClick_lightSourceCoupling = this.handleClick_lightSourceCoupling.bind(this);
    ...
    if (category !== null) {
      ...
      if (selectedSlot.includes("AdditionalSlot_")) {
        ...
        for (let index1 = 0; index1 < tmpSlots.length; index1++) {
          ...
          let compID = tmp.ID;
          for (let index2 = 0; index2 < settingData[selectedSlot].length; index2++) {
        ...
        let settingsName = selectedSchema.modelSettings + _constants.string_json_ext;
  ...
  handleClick_lightSource() {
    let category = _constants.channelPath_LightSource;
  ...
  handleClick_detector() {
    let category = _constants.channelPath_Detector;
  ...
  handleClick_couplingLens() {
    let category = _constants.channelPath_CouplingLens;
  ...
  handleClick_relayLens() {
    let category = _constants.channelPath_RelayLens;
  ...
  handleClick_lightSourceCoupling() {
    let category = _constants.channelPath_LightSourceCoupling;
  ...
  handleClick_excitation() {
    let category = _constants.channelPath_Excitation;
  ...
  handleClick_dichroic() {
    let category = _constants.channelPath_Dichroic;
  ...
  handleClick_emission() {
    let category = _constants.channelPath_Emission;
  ...
  handleClick_objective() {
    let category = _constants.channelPath_Objective;
  ...
  createAddButton(buttonStyle, addButtonImage, addButtonImageStyle, index, category, isEnabled) {
    let addButtonImagePath = addButtonImage + (addButtonImage.indexOf("githubusercontent.com") > -1 ? "?sanitize=true" : "");
    let image = /*#__PURE__*/_react.default.createElement("img", {
    ...
    let buttStyle = Object.assign({}, buttonStyle, {
      border: "none"
    });
  ...
  static createSlotButton(imagesPath, imageName, imageSlot, slots, compSchemas, style, buttonStyle, styleCloser, styleIcons, callback, deleteCallback, editCallback, text, isEnabled, valid) {
    let image = null;
    let name = text;
    ...
    let itemImage = /*#__PURE__*/_react.default.createElement("img", {
    ...
    if (needDelete) {
      ...
      if (isEnabled && hasSettings) {
        butt = /*#__PURE__*/_react.default.createElement("button", {
          style: buttonStyle,
          onClick: () => editCallback(element, compSchemas[element.Schema_ID], imageSlot)
        }, itemImage, name);
      } else {
        let buttStyle = Object.assign({}, buttonStyle, {
          border: "none"
  ...
  render() {
    ...
    if (this.state.editing) {
      if (this.state.editingSettings) {
        ...
        Object.keys(this.props.componentData).forEach(compIndex => {
          ...
          if (this.state.category.includes(schema_id.replace(_constants.string_json_ext, "")) || this.state.category.includes(compSchemaCategory) || this.state.category.includes(compSchemaCategory.substring(0, compSchemaCategory.indexOf(".")))) {
            if (selectedSlot.includes("AdditionalSlot_")) {
        ...
        if (selectedSlot.includes("AdditionalSlot_")) {
          ...
          Object.keys(items).forEach(compIndex => {
            ...
            if (compSchema.modelSettings !== "NA" && schemaHasProp) {
              butt = /*#__PURE__*/_react.default.createElement("button", {
                key: "button-" + comp.Name,
                style: buttonStyleModified,
                onClick: () => this.handleEditSettings(comp, compSchema, selectedSlot)
              }, compItemImage, comp.Name);
            } else {
              butt = /*#__PURE__*/_react.default.createElement("button", {
                key: "button-" + comp.Name,
            ...
            slotList.push(/*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
              ...
              type: "button",
              onClick: () => this.handleDeleteComp(selectedSlot, compIndex),
              style: styleCloser
            }, "x"), valid), butt));
          });
          let arrowedSlotList = [];
          for (let i = 0; i < slotList.length; i++) {
            ...
            let arrowItem = /*#__PURE__*/_react.default.createElement("div", {
              key: id1,
              style: {
                marginLeft: "20px",
                marginRight: "20px"
    ...
    let addButtonImage = url.resolve(this.props.imagesPath, _constants.string_add_img);
    ...
    let additionalItemButton_1 = this.createAddButton(buttonStyle, addButtonImage, hasChannelPath_Additional_1 ? addButtonImageStyle : opaqueAddButtonImageStyle, 1, _constants.channelPath_Additional_1, hasChannelPath_Additional_1);
    let additionalItemButton_2 = this.createAddButton(buttonStyle, addButtonImage, hasChannelPath_Additional_2 ? addButtonImageStyle : opaqueAddButtonImageStyle, 2, _constants.channelPath_Additional_2, hasChannelPath_Additional_2);
    let additionalItemButton_3 = this.createAddButton(buttonStyle, addButtonImage, hasChannelPath_Additional_3_4_5_6 ? addButtonImageStyle : opaqueAddButtonImageStyle, 3, _constants.channelPath_Additional_3_4_5_6, hasChannelPath_Additional_3_4_5_6);
    let additionalItemButton_4 = this.createAddButton(buttonStyle, addButtonImage, hasChannelPath_Additional_3_4_5_6 ? addButtonImageStyle : opaqueAddButtonImageStyle, 4, _constants.channelPath_Additional_3_4_5_6, hasChannelPath_Additional_3_4_5_6);
    let additionalItemButton_5 = this.createAddButton(buttonStyle, addButtonImage, hasChannelPath_Additional_3_4_5_6 ? addButtonImageStyle : opaqueAddButtonImageStyle, 5, _constants.channelPath_Additional_3_4_5_6, hasChannelPath_Additional_3_4_5_6);
    let additionalItemButton_6 = this.createAddButton(buttonStyle, addButtonImage, hasChannelPath_Additional_3_4_5_6 ? addButtonImageStyle : opaqueAddButtonImageStyle, 6, _constants.channelPath_Additional_3_4_5_6, hasChannelPath_Additional_3_4_5_6);
    let additionalItemButton_7 = this.createAddButton(buttonStyle, addButtonImage, hasChannelPath_Additional_7 ? addButtonImageStyle : opaqueAddButtonImageStyle, 7, _constants.channelPath_Additional_7, hasChannelPath_Additional_7);
    let additionalItemButton_8 = this.createAddButton(buttonStyle, addButtonImage, hasChannelPath_Additional_8 ? addButtonImageStyle : opaqueAddButtonImageStyle, 8, _constants.channelPath_Additional_8, hasChannelPath_Additional_8);
    let specButtStyle = Object.assign({}, buttonStyle, {
      border: "none"
    });
    let specimenButton = ChannelCanvas_V2.createSlotButton(this.props.imagesPath, "LightPath_10_Specimen.svg", "Specimen", slots, compSchemas, regularImageStyle, specButtStyle, styleCloser, styleIcons, null, null, null, "Specimen", false, null);
    ...
    let detectorButton = ChannelCanvas_V2.createSlotButton(this.props.imagesPath, "LightPath_9_Detector_outline.svg", "Detector", slots, compSchemas, hasDetector ? regularImageStyle : regularOpaqueImageStyle, buttonStyle, styleCloser, styleIcons, this.handleClick_detector, this.handleDeleteComp, this.handleEditSettings, "Select Detector", hasDetector, valid);
    ...
    let emissionButton = ChannelCanvas_V2.createSlotButton(this.props.imagesPath, "LightPath_6_EmissionFilter_outline.svg", "EmissionFilter", slots, compSchemas, hasEmission ? regularImageStyle : regularOpaqueImageStyle, buttonStyle, styleCloser, styleIcons, this.handleClick_emission, this.handleDeleteComp, this.handleEditSettings, "Select Emission Wavelength", hasEmission, valid);
    ...
    if (objective !== undefined && objective !== null) {
      ...
      if (schema !== null && schema !== undefined) {
        let schemaHasProp = Object.keys(schema.properties).length > 0;
        let schemaHasProp2 = Object.keys(immersionLiquidSchema.properties).length > 0;
        if (schemaHasProp || schemaHasProp2) {
          let validation = validate(objective, schema);
          let validated = validation.valid;
          let validation2 = validate(objective.ImmersionLiquid, immersionLiquidSchema);
    ...
    let objectiveButton = ChannelCanvas_V2.createSlotButton(this.props.imagesPath, "LightPath_7_Objective_outline.svg", "Objective", slots, compSchemas, hasObjective ? regularImageStyle : regularOpaqueImageStyle, buttonStyle, styleCloser, styleIcons, this.handleClick_objective, this.handleDeleteComp, this.handleEditSettings, "Objective", hasObjective, valid);
    let row1 = /*#__PURE__*/_react.default.createElement("div", {
      style: gridRow
    }, /*#__PURE__*/_react.default.createElement(_reactArcher.ArcherElement, {
      id: "lightSource",
      relations: [{
    ...
    let row2 = /*#__PURE__*/_react.default.createElement("div", {
      style: gridRowAdd
    }, /*#__PURE__*/_react.default.createElement(_reactArcher.ArcherElement, {
      id: "addButton_1",
      relations: [{
    ...
    let row3 = /*#__PURE__*/_react.default.createElement("div", {
      style: gridRow
    }, /*#__PURE__*/_react.default.createElement(_reactArcher.ArcherElement, {
      id: "couplingLens",
      relations: [{
    ...
    let row4 = /*#__PURE__*/_react.default.createElement("div", {
      style: gridRow
    }, /*#__PURE__*/_react.default.createElement(_reactArcher.ArcherElement, {
    ...
    let row5 = /*#__PURE__*/_react.default.createElement("div", {
      style: gridRowAdd
    }, /*#__PURE__*/_react.default.createElement(_reactArcher.ArcherElement, {
      id: "addButton_2",
      relations: [{
    ...
    let row6 = /*#__PURE__*/_react.default.createElement("div", {
