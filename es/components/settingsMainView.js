...
const schemas = ["Experiment.json", "Plane.json", "Channel.json", "TIRFSettings.json",
//TIRFHardwareModule
"ImagingEnvironment.json",
//EnvironmentalControlDevice
"MicroscopeStandSettings.json",
//InvertedMicroscopeStand, UprightMicroscopeStand
"ObjectiveSettings.json",
//Objective
"SamplePositioningSettings.json",
//Z-Drive, TurretObjectiveFocusing, IndividualObjectiveFocusing, MechanicalStage, PiezoElectricStage
"MicroscopeTableSettings.json" //MicroscopeTable
];
const elements = ["exp", "planes", "channels", "tirfSettings", "imgEnv", "micSettings", "objSettings", "samplePosSettings", "micTableSettings"];
const categories = [[], [], [], ["TIRFHardwareModule"], ["EnvironmentalControlDevice"], ["InvertedMicroscopeStand", "UprightMicroscopeStand"], ["Objective"], ["Z-Drive", "TurretObjectiveFocusing", "IndividualObjectiveFocusing", "MechanicalStage", "PiezoElectricStage"], ["MicroscopeTable"]];
class SettingMainView extends _react.default.PureComponent {
    ...
    if (props.settingSchemas !== undefined && props.settingSchemas !== null) {
      Object.keys(props.settingSchemas).forEach(schemaIndex => {
        ...
        if (schema_id === "MicroscopeStandSettings.json") {
          if (this.state.micSettings === null || this.state.micSettings === undefined) {
            let newElement = {
    ...
    if (props.experimentalSchemas !== undefined && props.experimentalSchemas !== null) {
      Object.keys(props.experimentalSchemas).forEach(schemaIndex => {
        ...
        if (schema_id === "Experiment.json" && this.props.hasExperimentalModel) {
          if (this.state.experiment === null || this.state.experiment === undefined) {
            let newElement = {
              Name: "".concat(schema.title),
              ID: uuid,
              Tier: schema.tier,
      ...
      if (Object.keys(data).length > 0) {
        ...
        if (oldObjSettings !== null && oldObjSettings !== undefined) {
          ...
          if (oldObjSettings.ImmersionLiquid !== null && oldObjSettings.ImmersionLiquid !== undefined) {
            ...
            let newImmersionLiquid = Object.assign(oldImmersionLiquid, data.ImmersionLiquid);
  ...
  render() {
    ...
    if (editingElement !== -1) {
      ...
      if (schema !== null && schema !== undefined) schemaHasProp = Object.keys(schema.properties).length > 0;
      let validation = null;
      let validated = null;
      let valid = null;
      ...
      if (this.props.hasAdvancedModel) {
        ...
        disabled = true;
        if (schemaHasProp) for (let catIndex in category) {
        ...
        buttons.push(/*#__PURE__*/_react.default.createElement(_Button.default, {
          key: "Button-TIRF",
          onClick: () => this.onClickEditSettings(elements.indexOf("tirfSettings")),
          style: styleButton,
          size: "lg",
          disabled: disabled
      ...
      buttons.push(/*#__PURE__*/_react.default.createElement(_popoverTooltip.default, {
        ...
        element: /*#__PURE__*/_react.default.createElement(_Button.default, {
          ...
          onClick: () => this.onClickEditSettings(elements.indexOf("micTableSettings")),
          style: styleButton,
          size: "lg",
          disabled: disabled
      ...
      buttons.push(/*#__PURE__*/_react.default.createElement(_popoverTooltip.default, {
        ...
        element: /*#__PURE__*/_react.default.createElement(_Button.default, {
          ...
          onClick: () => this.onClickEditSettings(elements.indexOf("micSettings")),
          style: styleButton,
          size: "lg",
          disabled: disabled
      ...
      schema_id = schemas[index];
      let immersionLiquidSchema = this.state.experimentalSchemas["ImmersionLiquid.json"];
      ...
      if (object !== null && object !== undefined && schemaHasProp) {
        ...
        if (object.ImmersionLiquid !== null && object.ImmersionLiquid !== undefined) {
          let validation2 = validate(object.ImmersionLiquid, immersionLiquidSchema);
      ...
      buttons.push(/*#__PURE__*/_react.default.createElement(_popoverTooltip.default, {
        ...
        element: /*#__PURE__*/_react.default.createElement(_Button.default, {
          ...
          onClick: () => this.onClickEditSettings(elements.indexOf("objSettings")),
          style: styleButton,
          size: "lg",
          disabled: disabled
      ...
      buttons.push(/*#__PURE__*/_react.default.createElement(_popoverTooltip.default, {
        ...
        element: /*#__PURE__*/_react.default.createElement(_Button.default, {
          ...
          onClick: () => this.onClickEditSettings(elements.indexOf("samplePosSettings")),
          style: styleButton,
          size: "lg",
          disabled: disabled
      ...
      let fluorophoreSchema = this.state.experimentalSchemas["Fluorophore.json"];
      validated = false;
      if (object !== null && object !== undefined) {
        if (Array.isArray(object)) {
          validated = true;
