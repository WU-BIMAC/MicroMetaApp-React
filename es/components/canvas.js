...
class Canvas extends _react.default.PureComponent {
  ...
  dropped(e) {
    ...
    let width = 100;
    let height = 100;
    let defaultOffset = _constants.number_canvas_element_icons_height /** scalingFactor*/ + _constants.number_canvas_element_offset_default;
            ...
            if (Array.isArray(keyMarkedSpots)) {
              for (let i = 0; i < keyMarkedSpots.length; i++) {
                ...
                newElementList.map((item, index) => {
                  ...
                  let yOff = item.y + item.height / 2 + defaultOffset + spot.y * scalingFactor; // + containerOffsetY;
                  let x1 = xOff - spotW / 2;
                  let x2 = xOff + spotW / 2;
                  let y1 = yOff - spotH / 2;
                  let y2 = yOff + spotH / 2;
    ...
    let minElementHeight = _constants.number_canvas_element_min_height * scalingFactor;
    let adjustedWidth = 0;
    ...
    y -= _constants.number_canvas_element_offset_default;
        ...
        if (Array.isArray(linkList)) {
          if (linkList.includes(deletedID)) {
            ...
            if (elementData[key] !== undefined) {
              elementData[key][field][index] = _constants.string_na;
              linkedFields[key][field].value[index] = _constants.string_na;
              done = true;
              break;
            }
          }
  ...
  createList() {
    ...
    let grabberCloserSize = _constants.number_canvas_element_icons_height * scalingFactor;
    ...
    elementList.map(item => {
      ...
      scaledContainerHeight += _constants.number_canvas_element_icons_height /* * scalingFactor */ + _constants.number_canvas_element_offset_default;
  ...
  render() {
    ...
    let standImageDimensions = elementDimensions[standSchemaID.replace(".json", "")][_constants.string_typeDimensionsGeneral];
    ...
    if (microscope !== null && microscope !== undefined) {
      ...
      if (microscope.MicroscopeStand !== undefined && microscope.MicroscopeStand !== null) {
        ...
        if (stand.Name !== null && stand.Name !== undefined) {
          micInfo.push("MicroscopeStand Name: ".concat(stand.Name));
          micInfo.push(/*#__PURE__*/_react.default.createElement("br", {
            key: "newline-2"
          }));
        }
        if (stand.Manufacturer !== null && stand.Manufacturer !== undefined) {
          micInfo.push("MicroscopeStand Manufacturer: ".concat(stand.Manufacturer));
          micInfo.push(/*#__PURE__*/_react.default.createElement("br", {
            key: "newline-3"
          }));
        }
        if (stand.Model !== null && stand.Model !== undefined) {
          micInfo.push("MicroscopeStand Model: ".concat(stand.Model));
          micInfo.push(/*#__PURE__*/_react.default.createElement("br", {
            key: "newline-4"
          }));
        }
        if (stand.Type !== null && stand.Type !== undefined) {
          micInfo.push("MicroscopeStand Type: ".concat(stand.Type));
          micInfo.push(/*#__PURE__*/_react.default.createElement("br", {
            key: "newline-5"
          }));
        }
