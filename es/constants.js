...
export var save_component_tooltip = {
  ...
  content: /*#__PURE__*/React.createElement("p", null, "Choose whether you want to save this Component file to the active Micro-Meta App repository or if you want to export it to your local file system."),
  position: "top"
};
...
export var save_setting_tooltip = {
  title: "Save settings",
  content: /*#__PURE__*/React.createElement("p", null, "Choose whether you want to save this Settings file to the active Micro-Meta App repository or if you want to export it to your local file system."),
  position: "top"
};
